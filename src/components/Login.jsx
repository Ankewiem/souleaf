        ...
        <div className="w-full max-w-[358px] flex flex-col gap-[25px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[20px]">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-[7.5px] cursor-pointer">
                <input 
                  type="checkbox" 
                  checked={formData.rememberMe}
                  onChange={(e) => handleInputChange('rememberMe', e.target.checked)}
                  className="w-[15px] h-[15px] border border-[rgba(2,2,2,0.5)] rounded-[2px] appearance-none flex-shrink-0 cursor-pointer relative checked:bg-[#9FDFB0] checked:border-[#9FDFB0]"
                />
                <span className="text-[15px] font-light tracking-[-0.75px] text-[#020202]">
                  Ghi nhớ đăng nhập
                </span>
              </label>
              <Link to="/forgot-password" className="text-[15px] font-medium text-[#9FDFB0] underline tracking-[-0.05em] hover:no-underline">
                Quên mật khẩu
              </Link>
            </div>
          ...
          <p className="text-[15px] font-light tracking-[-0.75px] text-[#020202] text-center">
            Chưa có tài khoản?&nbsp;
            <Link to="/register" className="text-[15px] font-medium text-[#9FDFB0] underline tracking-[-0.05em] hover:no-underline">
              Đăng ký
            </Link>
          </p>
        </div>
